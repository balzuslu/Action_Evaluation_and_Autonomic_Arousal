...
<br><br>
This table corresponds to the results section "Skin Conductance Response" in the manuscript and Table S5 in the supplemental material.  
...
```{r plot-pes-scr-original, cache = TRUE, fig.cap = "Note. Error bars indicate 95% confidence intervals."}

# Respecify LMM without interactions stated with ":" in random structure (because plot_model does not like that) 
