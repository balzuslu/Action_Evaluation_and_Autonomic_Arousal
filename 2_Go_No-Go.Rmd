...
# For go/no-go RT analysis, exclude inhibited responses, missing gng responses, gng responses with wrong key, and RT outliers
...
descriptive_statistics <- full_join(descriptive_statistics_rt, descriptive_statistics_proportion,
  ...
  dplyr::mutate(
    ci_rt         = paste0("[", gng_rt - ci,           ", ", gng_rt + ci, "]"),
    ci_proportion = paste0("[", mean   - CI.mean.0.95, ", ", mean   + CI.mean.0.95, "]")
  ) %>%
...
<br><br>
This table corresponds to the results section "Behavioral Performance in the Go/No-Go Task" in the paper and Table S7 in the Supplemental Material.  
